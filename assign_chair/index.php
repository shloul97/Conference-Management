...
if(isset($_SESSION['user_login'])){
    if(isset($_SESSION['user_role']) && $_SESSION['user_role'] == 2){
        ...
        $sql_tracks = "SELECT * FROM tracks WHERE conf_id = $conf_id AND track_status = 1";
        $result_track = mysqli_query($db,$sql_tracks);
                        ...
                        <form action="#" method="POST" id="chair-ass-form">                        
                            <div class="content-box" style="width: 100%;">
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="center">
                                            <h1 class="h3 mb-3 fw-normal">Assign Chair</h1>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <select class="form-control" name="track" id="select-track" required>
                                                <option value=""></option>
                                                <?php
                                                    while($row_tracks = mysqli_fetch_assoc($result_track)){
                                                        echo '<option value="'.$row_tracks['track_id'].'">'.$row_tracks['track_name'].'</option>';
                                                    }
                                                ?>
                                            </select>
                                            <label for="select-track">Select Track</label>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-floating center">
                                            <button class="btn btn-warning" type="submit" id="pc-ass-submit" style="width: 50%;">Invite</button>
                                        </div>
                                    </div>
                                </div>
