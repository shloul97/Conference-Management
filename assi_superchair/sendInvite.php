...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Dear ,</p>
                <p>We are delighted to extend an invitation for you to serve as the Super Chair for the upcoming <b>'.$confdata['acronym'].'</b>, which will be held on <b>'.$confdata['start_date'].'</b> at <b>'.$confdata['city'].' '.$confdata['country'].'</b>.</p>
                <h2>Position Details</h2>
                <p>Role: Super Chair</p>
                ...
                <a href="https://www.bee-conf.com/acceptance/index.php?token='.$token.'&invite=superchair" class="button">Accept Offer</a>
            ...
            <div class="footer">
                <p>Bee Conference Managment | Amm,JORDAN | webmaste@bee-conf.com</p>
            </div>
        </div>
    </body>
    </html>
    ...
    if(mail($to, $subject, $msg, implode("\r\n", $headers))){
        $sql_token = "INSERT INTO invite_token(token,conf_id,role_id,token_status) VALUES 
        (
            '$token',
            $conf_id,
            '$track_id',
